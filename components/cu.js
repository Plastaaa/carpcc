...
export default class ConcessionUnique extends React.Component {
    componentDidMount() {
        ...
        axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/getConcessByName.php?concess=${splittedSquare}&concesss=13`)
          .then(res => {
            const concess = res.data;
            this.setState({ concess });
        })
        axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/getAllCCByConcess.php?concess=${splittedSquare}concesss=13`)
            .then(res => {
                const ccs = res.data;
                this.setState({ ccs });
            })
            ...
            <div>
                <div className='lg:block hidden'>
                    ...
                    this.state.concess.map((concess) => (
                        <div className=''>
                            <Helmet>
                                <title>Carpiquet Camping-car - {concess.libelle}</title>
